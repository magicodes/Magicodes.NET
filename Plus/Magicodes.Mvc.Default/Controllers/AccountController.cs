...
using Magicodes.Mvc.Default.Models;
...
{
    [Authorize]
    public class AccountController : PlusControllerBase
    {
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            Magicodes.Web.Interfaces.GlobalApplicationObject.Current.ApplicationContext.ApplicationLog.Log(LoggerLevels.Debug, "DefaultUserName:" + loginInfo.DefaultUserName + "\tEmail:" + loginInfo.Email + "\tProviderKey:" + loginInfo.Login.ProviderKey + "\tExternalIdentity.Name:" + loginInfo.ExternalIdentity.Name + "\tExternalIdentity.Label:" + loginInfo.ExternalIdentity.Label + "\tExternalIdentity.Count:" + loginInfo.ExternalIdentity.Claims.Count());
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    return View("ExternalLoginConfirmation", new ExternalLoginConfirmationViewModel { Email = loginInfo.Email, UserNickName = loginInfo.DefaultUserName });
            }
        }
